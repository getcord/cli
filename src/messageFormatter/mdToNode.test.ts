...
const testCases: TestCase[] = [
  ...
  {
    name: 'Bold text - single mark',
    mdMessage: `This is *some bold text*`,
    nodeMessage: [
      {
        type: MessageNodeType.PARAGRAPH,
        children: [
  ...
  {
    name: 'Italic text - single mark',
    mdMessage: `This is _some italic text_`,
    nodeMessage: [
      {
        type: MessageNodeType.PARAGRAPH,
        children: [
  ...
  {
    name: 'Italic text - double mark',
    mdMessage: `This is __some italic text__`,
    nodeMessage: [
      {
        type: MessageNodeType.PARAGRAPH,
        children: [
  ...
  {
    name: 'Italic text - triple mark',
    mdMessage: `This is ___some italic text___`,
    nodeMessage: [
      {
        type: MessageNodeType.PARAGRAPH,
        children: [
